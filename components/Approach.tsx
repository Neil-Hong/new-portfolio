    ...
    <section className="w-fill py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
            ...
            description="We plan and strategize the project to ensure that we are on the same page with the client."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
            ...
            description="We design and develop the project to ensure that we are on the same page with the client."
        >
          <CanvasRevealEffect
            animationSpeed={3}
